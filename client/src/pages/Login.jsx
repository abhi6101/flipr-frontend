    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 font-sans transition-colors duration-300">
      ...
      <div className="flex items-center justify-center h-[calc(100vh-80px)]">
        ...
        >
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mb-8">⏳ The server may take 1 or 2 Minutes to start if it was idle. Please wait after clicking Login.</p>
